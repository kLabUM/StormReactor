...
We are still waiting on the SWMM pull request to be accepted. You can find our pull request here: https://github.com/OpenWaterAnalytics/Stormwater-Management-Model/pull/302. Once the pull request has been approved, a similar PySWMM pull request will be initiated. Then, the final version of StormReactor will be available 
